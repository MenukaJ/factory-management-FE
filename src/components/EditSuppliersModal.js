...
export class EditSuppliersModal extends Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit(event,props) {
        ...
        fetch('http://localhost:8080/supplier/update/'+this.props.id, {
            method: 'PUT',
            headers: {
                            ...
                            <Col sm={6}>
                                <Form onSubmit={this.handleSubmit}>
                                    ...
                                    <Form.Group controlId="name">
                                        ...
                                        <Form.Control type="text" name="name" required placeholder="Supplier Name" defaultValue = {this.props.name}/>
                                    </Form.Group>
                                    <Form.Group controlId="address">
                                        <Form.Label>Address</Form.Label>
                                        <Form.Control type="text" name="address" required placeholder="Address" defaultValue = {this.props.address}/>
                                    </Form.Group>
                                    <Form.Group controlId="contact">
                                        <Form.Label>Contact</Form.Label>
                                        <Form.Control type="text" name="contact" required placeholder="Contact" defaultValue = {this.props.contact}/>
                                    </Form.Group>
